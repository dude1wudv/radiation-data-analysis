...
\section{\^{}60Co γ 射线 0--60 krad(Si) 累积辐照下 S、T
组器件电学特性分析}\label{co-ux3b3-ux5c04ux7ebf-060-kradsi-ux7d2fux79efux8f90ux7167ux4e0b-st-ux7ec4ux5668ux4ef6ux7535ux5b66ux7279ux6027ux5206ux6790}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图1 S组不同总剂量下的转移特性（线性坐标）}]{../03_figures/pdf/transfer_linear_S.pdf}}
\caption{图1 S组不同总剂量下的转移特性（线性坐标）}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图2 S组不同总剂量下的转移特性（半对数坐标）}]{../03_figures/pdf/transfer_semilog_S.pdf}}
\caption{图2 S组不同总剂量下的转移特性（半对数坐标）}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图3 S组不同总剂量下的输出特性（VGS=-20 V，半对数坐标）}]{../03_figures/pdf/output_semilog_S.pdf}}
\caption{图3 S组不同总剂量下的输出特性（VGS=-20 V，半对数坐标）}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图4 T组不同总剂量下的转移特性（线性坐标）}]{../03_figures/pdf/transfer_linear_T.pdf}}
\caption{图4 T组不同总剂量下的转移特性（线性坐标）}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图5 T组不同总剂量下的转移特性（半对数坐标）}]{../03_figures/pdf/transfer_semilog_T.pdf}}
\caption{图5 T组不同总剂量下的转移特性（半对数坐标）}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图6 T组不同总剂量下的输出特性（VGS=-20 V，半对数坐标）}]{../03_figures/pdf/output_semilog_T.pdf}}
\caption{图6 T组不同总剂量下的输出特性（VGS=-20 V，半对数坐标）}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图7 S/T组阈值电压随总剂量的变化}]{../03_figures/pdf/threshold_voltage.pdf}}
\caption{图7 S/T组阈值电压随总剂量的变化}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图8 S/T组相对0 krad(Si)的阈值电压漂移}]{../03_figures/pdf/threshold_shift.pdf}}
\caption{图8 S/T组相对0 krad(Si)的阈值电压漂移}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图9 S/T组峰值跨导相对变化随总剂量的变化}]{../03_figures/pdf/gm_change.pdf}}
\caption{图9 S/T组峰值跨导相对变化随总剂量的变化}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图10 S/T组亚阈值摆幅随总剂量的变化}]{../03_figures/pdf/subthreshold_swing.pdf}}
\caption{图10 S/T组亚阈值摆幅随总剂量的变化}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图11 S/T组30 V漏电流随总剂量的变化}]{../03_figures/pdf/output_current_30v.pdf}}
\caption{图11 S/T组30 V漏电流随总剂量的变化}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图12 S/T组达到1 µA漏电流所需漏极电压随总剂量的变化}]{../03_figures/pdf/voltage_at_1ua.pdf}}
\caption{图12 S/T组达到1 µA漏电流所需漏极电压随总剂量的变化}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={图13 S组连续加压扫描后30 V漏电流相对首次扫描的降低}]{../03_figures/pdf/stress_recovery_30v.pdf}}
\caption{图13 S组连续加压扫描后30 V漏电流相对首次扫描的降低}
\end{figure}
